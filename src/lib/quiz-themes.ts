...
export const QUIZ_THEMES: Record<QuizThemeId, QuizTheme> = {
  default: {
    ...
    accent: '#FBD13B',
    accentText: '#0D0D0D',
    swatch: ['#F8F9FA', '#0F1B3D', '#FBD13B', '#FFFFFF'],
    dark: false,
  },
  classroom: {
    id: 'classroom',
    ...
    accent: '#FBD13B',
    accentText: '#0B3D2E',
    swatch: ['#0B3D2E', '#FBD13B', '#FFFFFF', '#B8D8C7'],
    dark: true,
  },
  'night-sky': {
    id: 'night-sky',
    ...
    accent: '#FBD13B',
    accentText: '#050A1F',
    swatch: ['#0F1B3D', '#FBD13B', '#1E2B6B', '#FFFFFF'],
    dark: true,
  },
  sunrise: {
    id: 'sunrise',
  ...
  paper: {
    ...
    accent: '#0F1B3D',
    accentText: '#FBD13B',
    swatch: ['#FEFCF3', '#3F3F46', '#FBD13B', '#D4D4D8'],
    dark: false,
  },
  ocean: {
    id: 'ocean',
  ...
  'minimal-dark': {
    ...
    accent: '#FBD13B',
    accentText: '#0F172A',
    swatch: ['#0F172A', '#1E293B', '#FBD13B', '#F8FAFC'],
    dark: true,
  },
}
