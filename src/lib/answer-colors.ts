...
// gold / green / purple) but lighter and more vibrant than the old sharp Kahoot
// clones. All keep white text legible (>=3:1 for large bold). The luminous look
// comes from rendering: a gradient (hexLight -> hex -> hexDark) plus a colored
// `glow` shadow — never by simply lightening the flat fill.
