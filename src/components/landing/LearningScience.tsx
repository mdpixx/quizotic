  ...
  return (
    <div style={{ width: '100%', maxWidth: 420 }}>
      <svg viewBox="0 0 400 230" width="100%" style={{ overflow: 'visible' }}>
        ...
        {/* Practice dots */}
        <circle cx="60" cy="15" r="6" fill="#FBD13B"/>
        <text x="68" y="28" fill="#FBD13B" fontFamily="DM Sans, sans-serif" fontSize="9" fontWeight="500">Session 1</text>
        <circle cx="160" cy="80" r="6" fill="#FBD13B"/>
        <text x="168" y="76" fill="#FBD13B" fontFamily="DM Sans, sans-serif" fontSize="9" fontWeight="500">Session 2</text>
        <circle cx="280" cy="55" r="6" fill="#FBD13B"/>
        <text x="288" y="52" fill="#FBD13B" fontFamily="DM Sans, sans-serif" fontSize="9" fontWeight="500">Session 3</text>
        {/* Legend */}
        ...
        <circle cx="190" cy="218" r="4" fill="#FBD13B"/>
...
function UspText({ num, title, subtitle, body, citation, tags }: { num: string; title: string; subtitle: string; body: string; citation: string; tags: string[] }) {
  return (
    <div>
      <div style={{ fontFamily: 'var(--font-heading, "Space Grotesk", sans-serif)', fontWeight: 800, fontSize: 48, color: '#FBD13B', marginBottom: 8 }}>{num}</div>
      ...
      <p style={{ fontFamily: 'var(--font-body, "DM Sans", sans-serif)', fontWeight: 600, fontSize: 16, color: '#FBD13B', marginBottom: 16 }}>{subtitle}</p>
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        {tags.map(t => (
          <span key={t} style={{ fontFamily: 'var(--font-body, "DM Sans", sans-serif)', fontSize: 12, fontWeight: 600, color: '#FBD13B', border: '1px solid rgba(251,209,59,0.4)', borderRadius: 20, padding: '4px 12px' }}>{t}</span>
        ))}
      </div>
    </div>
  )
    ...
    <section id="methodology" style={{ padding: 'clamp(56px, 11vw, 120px) 24px', background: '#0F1B3D' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <h2 style={{ fontFamily: 'var(--font-heading, "Space Grotesk", sans-serif)', fontWeight: 800, fontSize: 'clamp(28px, 3.5vw, 48px)', color: '#fff', letterSpacing: '-0.03em', textAlign: 'center', marginBottom: 16 }}>
          Built on <span style={{ color: '#FBD13B' }}>learning science,</span> not guesswork.
        </h2>
