    ...
    <div className="min-h-screen" style={{ background: '#FFFBF5' }}>
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-base leading-relaxed" style={{ color: '#374151' }}>
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#1B2559' }}>1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#1B2559' }}>2. How We Use Your Data</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#1B2559' }}>3. Data Storage & Security</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#1B2559' }}>4. Third-Party Services</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#1B2559' }}>5. Data Retention</h2>
            <p>Account data is retained as long as your account is active. Session data is retained for up to 12 months. You can request deletion of your account and all associated data by emailing <a href="mailto:info@quizotic.live" style={{ color: '#4361EE' }}>info@quizotic.live</a>.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#1B2559' }}>6. Your Rights</h2>
            <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:info@quizotic.live" style={{ color: '#4361EE' }}>info@quizotic.live</a>.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#1B2559' }}>7. Contact</h2>
            <p>For privacy-related questions, email us at <a href="mailto:info@quizotic.live" style={{ color: '#4361EE' }}>info@quizotic.live</a>.</p>
          </section>
        </div>
      </div>
    </div>
