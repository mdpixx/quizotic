    ...
    <div className="min-h-screen" style={{ background: '#FFFFFF' }}>
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-base leading-relaxed" style={{ color: '#374151' }}>
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>4. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>5. Content Ownership</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>6. AI-Generated Content</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>7. Billing & Subscriptions</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>8. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>9. Termination</h2>
            <p>We reserve the right to suspend or terminate accounts that violate these terms. You may delete your account at any time by contacting <a href="mailto:info@quizotic.live" style={{ color: '#0F1B3D' }}>info@quizotic.live</a>.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>10. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: '#0F1B3D' }}>11. Contact</h2>
            <p>For questions about these terms, email <a href="mailto:info@quizotic.live" style={{ color: '#0F1B3D' }}>info@quizotic.live</a>.</p>
          </section>
        </div>
      </div>
    </div>
