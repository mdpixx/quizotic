      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-sm mb-6" style={{ color: '#9CA3AF' }}>
            {quizzes.length === 0 ? 'Create your first quiz to get started' : 'Try a different search term'}
          </p>
          {quizzes.length === 0 && (
            <Link
              href="/host/create"
          ...
          <AnimatePresence>
            {filtered.map((quiz, i) => (
              <motion.div
                ...
                className="rounded-2xl border p-5 flex flex-col group"
              ...
              >
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {quiz.subject && (
                      <p className="text-xs mt-0.5 truncate" style={{ color: '#9CA3AF' }}>{quiz.subject}</p>
                    )}
                  </div>
                </div>

                <p className="text-[11px] mb-4" style={{ color: '#CBD5E1' }}>
                  Updated {new Date(quiz.updatedAt).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}
                </p>
      ...
      <AnimatePresence>
        {confirmDelete && (
          ...
          >
            ...
            >
              <h3 className="text-lg font-black mb-2" style={{ color: '#1B2559' }}>Delete Quiz?</h3>
